...
class OCRDataset(Dataset):
    ...
    def __init__(self, root, opt):
        """Custom dataset class that performs the following actions:
        1. Reads the labels.csv file to get the filename and words.
        2. Filters the images whose label is longer than opt.batch_max_length.
        3. Filters the images containing characters which are not in opt.character.
        4. Converts labels to lowercase if opt.sensitive is False.
        """
